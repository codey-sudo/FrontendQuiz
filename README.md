...
- [App.jsx](frontend-quiz/src/App.jsx)
- [App.test.js](frontend-quiz/src/App.test.js)
- [button.jsx](frontend-quiz/src/button.jsx)
- [data.json](frontend-quiz/src/data.json)
- [index.css](frontend-quiz/src/index.css)
- [index.js](frontend-quiz/src/index.js)
- [project_structure.text](frontend-quiz/src/project_structure.text)
